...
selectedPaymentBookingId = booking.id;
...
const paymentToken =
    document.getElementById("paymentToken");

if (paymentToken) {
    paymentToken.textContent =
        "Token: " + booking.token;
}
...
async function makePayment(paymentMethod) {
    ...
    try {
        ...
        const response = await fetch(
            ...
            `${API_URL}/api/bookings/${selectedPaymentBookingId}/payment`,
